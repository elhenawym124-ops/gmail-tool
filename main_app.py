...
def init_styles():
    ...
    <style>
        ...
        .glass-card {
            background: rgba(30, 41, 59, 1); /* Increased opacity for clarity */
...
with ui.column().classes('w-full max-w-7xl mx-auto p-6 gap-8'):
    ...
    with ui.card().classes('glass-card w-full p-0 overflow-hidden'):
        ...
        table = ui.table(columns=columns, rows=state.filtered_accounts, row_key='email').classes('w-full bg-transparent')
        ...
        table.add_slot('body-cell-actions', '''
            <q-td :props="props">
                ...
                <q-btn flat round color="amber" icon="edit" size="sm" @click="$parent.$emit('edit', props.row)">
